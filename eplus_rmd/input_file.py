...
class InputFile:
    ...
    def __init__(self, epjson_file_path: Path):
        self.load_epjson(epjson_file_path)
        self.load_output_json(epjson_file_path)
        self.load_hourly_output_json(epjson_file_path)

    def load_epjson(self, epjson_file_path: Path):
    ...
    def load_output_json(self, epjson_file_path: Path):
    ...
    def load_hourly_output_json(self, epjson_file_path):
