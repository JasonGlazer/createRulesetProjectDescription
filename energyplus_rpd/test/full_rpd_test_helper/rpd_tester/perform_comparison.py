...
def handle_ordered_comparisons(
    ...
    if (
        ...
        # Handle comparison of data which may not be in the same order as the reference subsurfaces
        aligned_generated_values = {}
        aligned_reference_values = {}
        ...
        generated_subsurface_ids = [subsurface["id"] for subsurface in generated_subsurfaces]
...
def run_comparison_for_all_tests(test_dir: Path):
    ...
    full_rpd_test_helper_dir = Path(__file__).parent.parent
    reference_dir = full_rpd_test_helper_dir / "reference_rpds"
    spec_dir = full_rpd_test_helper_dir / "comparison_specs"
