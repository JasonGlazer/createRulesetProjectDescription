    ...
    def test_add_heating_ventilation_system(self):
        ...
        expected_terminals = {
            'PERIMETER_MID_ZN_1 ZN': [{''
                                       ...
                                       'primary_airflow': 1090.0,
                                       'supply_design_heating_setpoint_temperature': '50.00',
                                       'supply_design_cooling_setpoint_temperature': '12.78',
                                       'minimum_airflow': 160.0,
                                       'minimum_outdoor_airflow': 90.0,
    ...
    def test_add_heating_ventilation_system_hp(self):
        ...
        expected_hvac = [{'id': 'CORE_ZN ZN PSZ-AC-1',
                          'heating_system': {'id': 'CORE_ZN ZN PSZ-AC-1-heating', 'design_capacity': 9209.122,
                                             ...
                                             'oversizing_factor': 1.0000002171760167,
                                             'is_sized_based_on_design_day': True, 'efficiency_metric_values': [0.8],
                                             'efficiency_metric_types': ['THERMAL_EFFICIENCY']},
                          'fan_system': {'id': 'CORE_ZN ZN PSZ-AC-1 FAN-fansystem', 'supply_fans': [
                              {'id': 'CORE_ZN ZN PSZ-AC-1 FAN', 'design_airflow': 0.37,
                               'is_airflow_sized_based_on_design_day': True,
                               'design_electric_power': 415.54, 'design_pressure_rise': 622.72,
                               'total_efficiency': 0.56,
                               'motor_efficiency': 0.85, 'motor_heat_to_airflow_fraction': 1.0,
                               'motor_heat_to_zone_fraction': 1.0,
                          ...
                          'cooling_system': {'id': 'CORE_ZN ZN PSZ-AC-1-cooling',
                                             ...
                                             'oversizing_factor': 1.1139819883026787,
                                             'is_sized_based_on_design_day': True,
                         ...
                         {'id': 'PERIMETER_ZN_1 ZN PSZ-AC-2',
                          ...
                          'cooling_system': {'id': 'PERIMETER_ZN_1 ZN PSZ-AC-2-cooling',
                                             ...
                                             'oversizing_factor': 1.1174651049343538,
                                             'is_sized_based_on_design_day': True,
                                             'efficiency_metric_values': [3.53, 12.05, 11.97, 11.7],
                                             'efficiency_metric_types': ['FULL_LOAD_COEFFICIENT_OF_PERFORMANCE',
                                                                         'ENERGY_EFFICIENCY_RATIO',
                         ...
                         {'id': 'PERIMETER_ZN_2 ZN PSZ-AC-3',
                          ...
                          'cooling_system': {'id': 'PERIMETER_ZN_2 ZN PSZ-AC-3-cooling',
                                             ...
                                             'oversizing_factor': 1.065704625512932,
                                             'is_sized_based_on_design_day': True,
                                             'efficiency_metric_values': [3.53, 12.05, 11.97, 11.7],
                                             'efficiency_metric_types': ['FULL_LOAD_COEFFICIENT_OF_PERFORMANCE',
                                                                         'ENERGY_EFFICIENCY_RATIO',
                         ...
                         {'id': 'PERIMETER_ZN_3 ZN PSZ-AC-4',
                          ...
                          'cooling_system': {'id': 'PERIMETER_ZN_3 ZN PSZ-AC-4-cooling',
                                             ...
                                             'oversizing_factor': 1.1150763369494419,
                                             'is_sized_based_on_design_day': True,
                                             'efficiency_metric_values': [3.53, 12.05, 11.97, 11.7],
                                             'efficiency_metric_types': ['FULL_LOAD_COEFFICIENT_OF_PERFORMANCE',
                                                                         'ENERGY_EFFICIENCY_RATIO',
                         ...
                         {'id': 'PERIMETER_ZN_4 ZN PSZ-AC-5',
                          ...
                          'cooling_system': {'id': 'PERIMETER_ZN_4 ZN PSZ-AC-5-cooling',
                                             ...
                                             'oversizing_factor': 1.0921253540282014,
                                             'is_sized_based_on_design_day': True,
                                             'efficiency_metric_values': [3.53, 12.05, 11.97, 11.7],
                                             'efficiency_metric_types': ['FULL_LOAD_COEFFICIENT_OF_PERFORMANCE',
                                                                         'ENERGY_EFFICIENCY_RATIO',
        ...
        expected_terminals = {'CORE_ZN ZN': [
            {'id': 'ADU CORE_ZN ZN PSZ-AC-1 DIFFUSER', 'type': 'CONSTANT_AIR_VOLUME', 'heating_source': 'NONE',
             ...
             'primary_airflow': 370.0, 'supply_design_heating_setpoint_temperature': '50.00',
            ...
            'PERIMETER_ZN_1 ZN': [
                {'id': 'ADU PERIMETER_ZN_1 ZN PSZ-AC-2 DIFFUSER', 'type': 'CONSTANT_AIR_VOLUME',
                 ...
                 'primary_airflow': 340.0, 'supply_design_heating_setpoint_temperature': '50.00',
                 'supply_design_cooling_setpoint_temperature': '12.78', 'minimum_airflow': 90.0,
                 'minimum_outdoor_airflow': 50.0, 'heating_capacity': 3729.13, 'cooling_capacity': 3755.63}],
            'PERIMETER_ZN_2 ZN': [
                {'id': 'ADU PERIMETER_ZN_2 ZN PSZ-AC-3 DIFFUSER', 'type': 'CONSTANT_AIR_VOLUME',
                 ...
                 'primary_airflow': 290.0, 'supply_design_heating_setpoint_temperature': '50.00',
            ...
            'PERIMETER_ZN_3 ZN': [
                {'id': 'ADU PERIMETER_ZN_3 ZN PSZ-AC-4 DIFFUSER', 'type': 'CONSTANT_AIR_VOLUME',
                 ...
                 'primary_airflow': 320.0, 'supply_design_heating_setpoint_temperature': '50.00',
                 'supply_design_cooling_setpoint_temperature': '12.78', 'minimum_airflow': 90.0,
                 'minimum_outdoor_airflow': 50.0, 'heating_capacity': 3761.15, 'cooling_capacity': 3501.01}],
            'PERIMETER_ZN_4 ZN': [
                {'id': 'ADU PERIMETER_ZN_4 ZN PSZ-AC-5 DIFFUSER', 'type': 'CONSTANT_AIR_VOLUME',
                 ...
                 'primary_airflow': 350.0, 'supply_design_heating_setpoint_temperature': '50.00',
                 'supply_design_cooling_setpoint_temperature': '12.78', 'minimum_airflow': 50.0,
