    ...
    if schema_yaml_dict[data_group_name]["Object Type"] == "Data Group":
        for data_group_element in schema_yaml_dict[data_group_name]["Data Elements"]:
            ...
            if "Data Type" in schema_yaml_dict[data_group_name]["Data Elements"][data_group_element]:
                # didn't check for # Data Type:
                # "(<OutputSchemaOptions2019ASHRAE901>, <OutputSchemaOptions2019T24>, OutputSchemaOptionsRESNET)"
                # "{}"
        ...
        for file in files:
            if file.endswith(".json"):
                ...
                for test_name in test_list_dictionary:
                    if "rmd_transformations" in test_list_dictionary[test_name]:
                        for transformation in test_list_dictionary[test_name]["rmd_transformations"]:
                            used_keys(test_list_dictionary[test_name]["rmd_transformations"][transformation],
                                      yaml_found_keys,
